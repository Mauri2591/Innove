...
if nombres == nombres:
    print(nombres.lower()+" "+nombres.upper()+" "+nombres.capitalize());

# nombre1=input("Ingrese su nombre completo: ").lower();
# nombre2=input("Ingrese su nombre completo: ").upper();
# nombre3=input("Ingrese su nombre completo: ").capitalize();
