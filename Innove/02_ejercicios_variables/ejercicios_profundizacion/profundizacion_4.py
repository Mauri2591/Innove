...
nombreComPadre = input("\nPadre, ingrese su nombre completo: \n");
nombreComMadre = input("Madre, ingrese su nombre completo: \n");
nombreHijo= input("Hijo, ingrese su nombre solamente: \n");

nombrePadre1,nombrePadre2,apellidoPadre = nombreComPadre.split(' ');
nombreMadre1,nombreMadre2,apellidoMadre = nombreComMadre.split(' ');

nomHijoFinal= nombreHijo +" "+ str(apellidoPadre) +" "+ str(apellidoMadre);
print("El nombre completo del hijo es: "+nomHijoFinal);
